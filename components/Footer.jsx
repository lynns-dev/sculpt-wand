  ...
  return (
    <footer style={footer}>
      <div style={{ ...S.wrap, display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 18 }}>
        <span style={{ fontFamily: T.display, fontStyle: 'italic', fontWeight: 600, fontSize: 18, color: T.ink }}>Sunbeam Body</span>
        ...
        <small style={{ width: '100%', color: T.soft, fontSize: 12, textAlign: 'center', marginTop: 8 }}>
          © {new Date().getFullYear()} Sunbeam Body. All rights reserved.
        </small>
      </div>
    </footer>
  );
