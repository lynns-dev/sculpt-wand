  ...
  if (id === 'travel-pouch') {
    return (
      <svg width={width} viewBox="0 0 220 220" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
        <rect x="40" y="70" width="140" height="120" rx="18" fill="#F1EEE0" stroke="#1C1B17" strokeWidth="2" />
        <path d="M70 70 v-14 a40 40 0 0 1 80 0 v14" fill="none" stroke="#1C1B17" strokeWidth="2" />
        <circle cx="110" cy="130" r="4" fill="#1C1B17" />
      </svg>
    );
  }
