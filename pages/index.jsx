...
const heroBlobA = { position: 'absolute', top: '-10%', right: '-8%', width: 420, height: 420, borderRadius: '50%', background: 'rgba(110,118,88,0.2)', filter: 'blur(10px)' };
const heroBlobB = { position: 'absolute', bottom: '-15%', left: '-10%', width: 360, height: 360, borderRadius: '50%', background: 'rgba(227,226,210,0.6)', filter: 'blur(10px)' };
...
const buyCardHighlight = { border: `1.5px solid ${T.rose}`, boxShadow: '0 16px 40px rgba(110,118,88,0.2)' };
