// Shared post-payment side effects for every checkout path (Square card
...
export async function fulfillOrder({ id, amount, items, eventId, url, req, paymentMethod, attribution }) {
  try {
    await recordOrder({
      id, amount, items,
